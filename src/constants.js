...
export const SEGMENTS = [
  ...
  {tier:"3차",tierLabel:"조건부 유입",tierColor:"#f59e0b",tierBg:"rgba(245,158,11,0.08)",tierBorder:"rgba(245,158,11,0.25)",
    groups:[
      ...
      {id:9,name:"9 전략적 투자자 그룹",short:"전략투자자",icon:"💰",color:"#84cc16",desc:"청약의사 == '조건' AND 구매목적: 투자 OR 증여"},
      {id:10,name:"10 정보 탐색 그룹",short:"정보탐색",icon:"🌱",color:"#6ee7b7",desc:"청약의사 == '조건' AND 구매목적: 기타 (450명)"},
    ]},
